...
const Navbar: React.FC = () => {
  return (
    <div>
      <Link
        className="navbar-brand text-light d-block d-sm-none container-sm text-center fw-bold m-auto py-3"
        to="/"
      >
          ...
          <div className="m-1 p-1 container  row" id="main-nav">
            <ul className="navbar-nav justify-content-around justify-content-sm-end">
              <li className=" text-center col-6 col-sm-4 col-lg-3 nav-item">
                <Link
                  className="nav-link px-sm-3 mx-sm-3 text-light fw-bold d-flex justify-content-center"
                  to="/shop"
                >
                  Shop
                </Link>
